#!/bin/sh
# gatygo_transform IN OUT TPROXY_PORT DNS_PORT MARK LOGLEVEL
...
gatygo_transform() {
    _gatygo_in=$1 _gatygo_out=$2 _gatygo_tp=$3 _gatygo_dp=$4 _gatygo_mark=$5 _gatygo_lvl=$6
